...
public class GoodsController {
	...
	public Goods loadGoodsById(GoodsVo goodsVo) {
		return goodsService.queryGoodsById(goodsVo.getId());
	}
	...
	/**************商品销售开始****************/
	@RequestMapping("loadAllGoodsForList")
	public List<Goods> loadAllGoodsForList(GoodsVo goodsVo){
		return goodsService.loadAllGoodsForList(goodsVo);
	}
	/**************商品销售开始****************/
	
	/**************桌面预警库存***************/
	@RequestMapping("loadAllDangerNumber")
	public List<Goods> queryAllDangerNumber(GoodsVo goodsVo){
		return goodsService.queryAllDangerNumber(goodsVo);
	}
	/**************桌面预警库存***************/
}
